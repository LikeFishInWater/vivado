...
* All right reserved.
*
* Filename: Modu_Block_Dual_RAM_sys.v
* Abstract: This is the verilog file that define the RAM for system. The address_width
* and data_width can be set as wanted.This module is initialed by the input system.txt.
*
* Version:  V5.0
* Author:   Duck
* Time:		2011-11-01
...
module Modu_Block_Dual_RAM_sys(
	//input
...
//	reg [RAM_WIDTH-1:0] Dual_RAM [799:0];
	
	initial 
	begin
		//$readmemb("system.txt",Dual_RAM,0,`BLOCK_SIZE-1'b1);
		$readmemb("C:\\Graduate\\PCIe\\Turbo\\pcie_turbo_debug\\data\\system.txt", Dual_RAM,0,800);
	end
