...
* All right reserved.
*
* Filename: Modu_Block_Dual_RAM_par1.v
* Abstract: This is the verilog file that define the RAM for parity1. The address_width
* and data_width can be set as wanted.This module is initialed by the input parity1.txt.
*
* Version:  V5.0
* Author:   Duck
* Time:		2011-11-01
...
module Modu_Block_Dual_RAM_par1(
	//input
   ...
   parameter RAM_ADDR_BITS = 7'b0000000;
	...
	initial 
	begin
		//$readmemb("parity1.txt",Dual_RAM,0,`BLOCK_SIZE-1'b1);
		$readmemb("C:\\Graduate\\PCIe\\Turbo\\pcie_turbo_debug\\data\\parity1.txt",Dual_RAM,0,800);
	end
