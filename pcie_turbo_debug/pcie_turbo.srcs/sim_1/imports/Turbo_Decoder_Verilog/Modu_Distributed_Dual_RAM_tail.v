...
* All right reserved.
*
* Filename: Modu_Distributed_Dual_RAM_tail.v
* Abstract: This is the verilog file that define the distributes block dual-port RAM. The 
* data_width can be set as wanted.The tail-RAM uses this module, and the RAM is initialed by
* the file tail.txt
*
* Version:  V5.0
* Author:   Duck
...
*/
module Modu_Distributed_Dual_RAM_tail(
	//input
   ...
   reg [RAM_WIDTH-1:0] Dual_RAM [(2**RAM_ADDR_BITS)-1:0];
	...
	initial
	begin
		$readmemb("C:\\Graduate\\PCIe\\Turbo\\pcie_turbo_debug\\data\\tail.txt",Dual_RAM,0,5);
	end
